...
#ggsave('Empl_Occ_Apr.png', plot = plot_occ, path = '/home/alice/Dropbox/PostDoc/UBI_EITC/', width = 25, height = 18, units = c('cm'))
...
#ggsave('EITC_Occ_Apr.png', plot = plot_eitc, path = '/home/alice/Dropbox/PostDoc/UBI_EITC/', width = 35, height = 20,  units = c('cm'))
...
#ggsave('W_Dist_Rout_Apr.png', plot = dist_rout, path = '/home/alice/Dropbox/PostDoc/UBI_EITC/', width = 20, height = 15,  units = c('cm'))
...
#ggsave('Empl_Rout_Apr.png', plot = plot_rout, path = '/home/alice/Dropbox/PostDoc/UBI_EITC/', width = 25, height = 18,  units = c('cm'))
...
ggsave('Hrs_Occ_Emp_Apr.png', plot = plot_hrs_emp, path = '/home/alice/Dropbox/PostDoc/UBI_EITC/', width = 32, height = 17,  units = c('cm'))
...
ggsave('Hrs_Occ_apr.png', plot = plot_hrs, path = '/home/alice/Dropbox/PostDoc/UBI_EITC/', width = 32, height = 17,  units = c('cm'))
...
ggsave('Earn_Occ_Emp_apr.png', plot = plot_earn, path = '/home/alice/Dropbox/PostDoc/UBI_EITC/', width = 32, height = 17,  units = c('cm'))
